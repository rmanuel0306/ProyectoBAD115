...
create or replace procedure savePersona (idmunic PERSONA.ID_MUNIC%TYPE,priNombre PERSONA.PRIMER_NOMBRE%TYPE,segNombre PERSONA.SEGUNDO_NOMBRE%TYPE,
...
fechNac PERSONA.FECHA_NAC%TYPE,v_dui PERSONA.DUI%TYPE,v_email PERSONA.E_MAIL%TYPE,direc PERSONA.DIRECCION%TYPE,historico PERSONA.ESHISTORICO%TYPE)
IS
BEGIN
INSERT INTO PERSONA(ID_MUNIC,PRIMER_NOMBRE,SEGUNDO_NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,CARGO,SEXO,FECHA_NAC,DUI,E_MAIL,DIRECCION,ESHISTORICO) VALUES 
(idmunic,priNombre,segNombre,priApellido,segApellido,carg,v_sexo,fechNac,v_dui,v_email,direc,historico);
COMMIT;
END savePersona;
...
/
-- PROCEDIMIENTOS MODULO TELEFONO
CREATE OR REPLACE PROCEDURE saveTelefono(idPersona TELEFONO.ID_PERSONA%TYPE,telFijo TELEFONO.TELEFONO_FIJO%TYPE,telMovil TELEFONO.TELEFONO_MOVIL%TYPE,
telAuxiliar TELEFONO.TELEFONO_AUXILIAR%TYPE)
IS
BEGIN
INSERT INTO TELEFONO(ID_PERSONA,TELEFONO_FIJO,TELEFONO_MOVIL,TELEFONO_AUXILIAR) VALUES (idPersona,telFijo,telMovil,telAuxiliar);
END saveTelefono;
